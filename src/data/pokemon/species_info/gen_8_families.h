...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DIPPLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_HYDRAPPLE}),  // NUZLOCKE: was IF_KNOWS_MOVE
    },
    ...
    [SPECIES_TOXEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_TOXTRICITY_LOW_KEY},
                                {EVO_LEVEL, 30, SPECIES_TOXTRICITY_AMPED}),  // NUZLOCKE: was a form-split condition; laddered so both stay reachable
    },
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_GRAPPLOCT}),  // NUZLOCKE: was IF_KNOWS_MOVE
    },
    ...
    [SPECIES_MILCERY] =
    {
        ...
        // NUZLOCKE: this was 63 EVO_SPIN rows - one per Sweet x Cream x time-of-day
        // combination - which the level-based rule cannot ladder (63 stacked
        // thresholds would be absurd, and only the first row could ever match).
        // Milcery evolves on level alone into the default Strawberry/Vanilla
        // Alcremie; the other 62 cosmetic forms are not reachable in this hack.
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM})
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_FROSMOTH}),  // NUZLOCKE: was IF_MIN_FRIENDSHIP
    },
    ...
    [SPECIES_KUBFU] =
    {
        ...
        // NUZLOCKE: the two EVO_SCRIPT_TRIGGER rows were dropped - the Scroll of
        // Darkness / Waters item rows below already reach both forms.
