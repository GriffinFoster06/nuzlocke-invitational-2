...
void SanitizeBoxWallpapers(void);   // clamp any out-of-range stored box wallpaper id
void SetBoxWallpaperSky(u8 boxId);  // bounds-checked; Phase 3 Nuzlocke graveyard box
