...
static const struct SettingDescriptor sSettingDescriptors[NUM_SETTINGS] =
{
    ...
    [SETTING_NICKNAME_MODE] = DESC_ENUM(SETTING_CAT_NUZLOCKE, RUL, NICK_STRICT, SETTING_FLAG_NONE,
        sLbl_Nickname, 2, "Nicknames",
        "Whether every obtained Pokemon must be nicknamed."),
    ...
    [SETTING_EVOLUTION_ASSISTANCE] = DESC_BOOL(SETTING_CAT_TRAVERSAL, FREE, 1, SETTING_FLAG_NONE,
        "Evolution Assistance",
        "Guarantee moves required specifically for evolution."),
...
static const struct RulesetPresetOverride sPresetOverrides_ModernEmerald[] =
{
    ...
    { SETTING_NICKNAME_MODE,                 NICK_OPTIONAL },
    { SETTING_NO_BATTLE_ITEMS,               0 },
