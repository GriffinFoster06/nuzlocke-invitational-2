...
#define I_FISHING_ALWAYS_BITE       TRUE       // After the current map's fishing table is validated, every rod cast takes the normal bite path.
#define I_FISHING_MINIGAME          GEN_1      // Uses the existing no-cancel, untimed A-button hook path. Only the Gen 1/2 and Gen 3 minigames are implemented.
