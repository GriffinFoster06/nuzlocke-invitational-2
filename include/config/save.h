...
// SaveBlock1 configs
#define FREE_EXTRA_SEEN_FLAGS_SAVEBLOCK1    TRUE    // Free up unused Pokédex seen flags (52 bytes). Reclaimed for the expanded bag (docs/SPEC.md "Expanded Bag").
...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE    // Frees up ramScript (1104 bytes). Dead in a single-player hack; reclaimed for the expanded bag (docs/SPEC.md "Expanded Bag").
